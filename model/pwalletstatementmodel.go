...
func NewPWalletStatementModel(conn sqlx.SqlConn, cache cache.CacheConf) PWalletStatementModel {
	return &customPWalletStatementModel{
		defaultPWalletStatementModel: newPWalletStatementModel(conn, cache),
	}
}
